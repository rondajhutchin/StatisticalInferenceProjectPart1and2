...
```
## Comparison summary.  The sample Variances and Standard Deviation are close.
The previous chart show how close the distribution is to normal.
```{r}

SampleConfidence <- round (mean(MySimSampleMean) + c(-1,1)*1.96*sd(MySimSampleMean)/sqrt(NumberExp),3)
